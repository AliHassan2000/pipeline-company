...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllArpFromIpamApiDates")
          .then((response) => {
        ...
        const status = await axios.get(
          baseUrl + "/getArpFromIpamApiScriptStatus"
        );
        console.log("popo");
        console.log(status);
        ...
        const res = await axios.get(baseUrl + "/getAllArpFromIpamApi");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "arp");
    XLSX.writeFile(wb, "arp.xlsx");
  ...
  const fetch = async () => {
    ...
    setBackgroundColor("red");
    await axios
      .get(baseUrl + "/findArpFromIpamApi")
      .then((response) => {

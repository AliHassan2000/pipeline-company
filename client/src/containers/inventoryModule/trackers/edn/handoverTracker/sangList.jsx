...
import { Table, Button, notification, Spin, Modal } from "antd";
...
const Index = ({ hoRefId, setIsSnagModalVisible }) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      // setLoading(true);
      try {
        const res = await axios.get(baseUrl + "/snags/" + hoRefId);
        excelData = res.data;
            ...
            <>
              ...
              >
                ...
                <div style={{ display: "flex" }}>
                  ...
                  &nbsp;
                  <StyledButton
                    onClick={() => setIsSnagModalVisible(false)}
                    color={"#bb0a1e"}
                  >

...
const OpenJobs = () => {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      const res = await axios.get(baseUrl + "/dismantledDevicesPerMonthEdnSys");
      setBarData(res?.data);
      console.log("dismantledDevicesPerMonthEdnSys");
    ...
    <MainContainer>
      ...
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={barData} barSize={15}>
          ...
          <Tooltip />
          <Bar dataKey="EDN-SYS" fill="black" label={<CustomizedLabel />}>

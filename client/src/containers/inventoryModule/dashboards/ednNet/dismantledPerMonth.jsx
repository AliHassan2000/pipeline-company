...
const OpenJobs = () => {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      const res = await axios.get(baseUrl + "/dismantledDevicesPerMonthEdnNet");
      setBarData(res?.data);
      console.log("dismantledDevicesPerMonthEdnNet");
    ...
    <MainContainer>
      ...
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={barData} barSize={15}>
          ...
          <Tooltip />
          <Bar dataKey="EDN-NET" fill="black" label={<CustomizedLabel />}>

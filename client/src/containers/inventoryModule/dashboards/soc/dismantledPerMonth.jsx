...
const OpenJobs = () => {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      const res = await axios.get(baseUrl + "/dismantledDevicesPerMonthSoc");
      setBarData(res?.data);
      console.log("dismantledDevicesPerMonthSoc");
    ...
    <MainContainer>
      ...
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={barData} barSize={15}>
          ...
          <Tooltip />
          <Bar dataKey="SOC" fill="black" label={<CustomizedLabel />}>

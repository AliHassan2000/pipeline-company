...
import PoweredOffPerMonth from "./poweredOffPerMonth";
import OffloadedPerMonth from "./offloadedPerMonth";
import {
  PieChart,
  Pie,
  Cell,
...
import CustomPieChartLabel from "../../../components/graphs";
...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      setLoading(true);
      try {
        const tags = await axios.get(baseUrl + "/tagId");
        setTags(tags.data);
        console.log(removeZeros(tags.data));

        const statGrowth = await axios.get(baseUrl + "/pnCodeStatGrowth");
        setStatGrowth(statGrowth.data);
        console.log(statGrowth.data);

        const eos = await axios.get(baseUrl + "/eosExpiry");
        setEOSExpiry(removeZeros(eos.data));
        console.log(eos.data);

        const res = await axios.get(baseUrl + "/ciscoDomains");
        setDomains(removeZeros(res.data));
        console.log(res.data);

        const res2 = await axios.get(baseUrl + "/inventoryCounts");
        setInventoryCounts(res2.data);
        console.log(res2.data);

        const res3 = await axios.get(baseUrl + "/deviceFunctions");
        setFunctions(res3.data);
        console.log(res3.data);

        let a = [];
        const res4 = await axios.get(baseUrl + "/totalDeviceFunctions");
        a.push(res4.data);
        setTotalFunctions(a);

        const res5 = await axios.get(baseUrl + "/sitesPerSiteType ");
        setSiteTypes(res5.data);

        const res6 = await axios.get(baseUrl + "/tagIdVDate");
        setTagIdVDate(res6.data);
  ...
  const removeZeros = (data) => {
    return data.filter((domain) => domain.value > 0);
  };

  const getTotal = (data) => {
    let c = data.reduce((total, domain) => total + domain.value, 0);
    console.log("piechart", c);
    return c;
  };
      ...
      topCards.push(
        <Col span={6} style={{ paddingBottom: "20px" }}>
          <div>
            ...
            >
              {data.name} &nbsp;{" "}
              <Link to={`${url}?domain=All`} style={{ color: "white" }}>
                <ArrowRightOutlined />
              </Link>
            </StyledCard>
          </div>
  ...
  const columnsDeviceFunctions = [
    {
      ...
      sorter: (a, b) => a.site_name - b.site_name,
    ...
    },
    {
      ...
      key: "device_count",
      width: "13%",
      // ...getColumnSearchProps("device_count"),
      sorter: (a, b) => a.device_count - b.device_count,
      sortOrder: sortedInfo.columnKey === "device_count" && sortedInfo.order,
      ellipsis: true,
    },

    {
      ...
      sortOrder: sortedInfo.columnKey === "router" && sortedInfo.order,
      ellipsis: true,
    },
    {
      title: "Server",
      ...
      key: "server",
      width: "12%",
      // ...getColumnSearchProps("server"),
      sorter: (a, b) => a.server.length - b.server.length,
      sortOrder: sortedInfo.columnKey === "server" && sortedInfo.order,
      ellipsis: true,
    },
    {
      title: "Switch",
      ...
      key: "switch",
      width: "13%",
      // ...getColumnSearchProps("switch"),
      sorter: (a, b) => a.switch.length - b.switch.length,
      sortOrder: sortedInfo.columnKey === "switch" && sortedInfo.order,
      ellipsis: true,
    },
    {
      title: "Firewall",
      ...
      key: "firewall",
      width: "13%",
      // ...getColumnSearchProps("firewall"),
      sorter: (a, b) => a.firewall.length - b.firewall.length,
      sortOrder: sortedInfo.columnKey === "firewall" && sortedInfo.order,
      ellipsis: true,
    },
    {
      title: "Security Server",
      dataIndex: "security_server",
      key: "security_server",
      width: "13%",
      // ...getColumnSearchProps("security_server"),
      sorter: (a, b) => a.security_server.length - b.security_server.length,
      sortOrder: sortedInfo.columnKey === "security_server" && sortedInfo.order,
      ellipsis: true,
    },
    {
      title: "ACI",
      ...
      key: "aci",
      width: "13%",
      // ...getColumnSearchProps("aci"),
      sorter: (a, b) => a.aci.length - b.aci.length,
      sortOrder: sortedInfo.columnKey === "aci" && sortedInfo.order,
      ellipsis: true,
    },
  ];

  const columnsTotalDeviceFunctions = [
    {
      title: "Total Devices",
      ...
      sortOrder: sortedInfo.columnKey === "total_devices" && sortedInfo.order,
      ellipsis: true,
    },
    {
      title: "Total Routers",
    ...
    {
      title: "Total EDN Ipt Endpoints",
      dataIndex: "edn_ipt_endpoints",
      key: "edn_ipt_endpoints",
      width: "15%",
      // ...getColumnSearchProps("aci"),
      sorter: (a, b) => a.aci.length - b.aci.length,
      sortOrder: sortedInfo.columnKey === "aci" && sortedInfo.order,
                ...
                {domains ? (
                  <PieChart>
                    ...
                    <Pie
                      ...
                      label={<CustomPieChartLabel total={getTotal(domains)} />}
                      outerRadius={100}
                      dataKey="value"
                      minAngle={3}
                      labelLine={false}
                ...
                {tagIdVDate ? (
                  <PieChart>
                    ...
                    <Pie
                      ...
                      isAnimationActive={false}
                      label={
                        <CustomPieChartLabel total={getTotal(tagIdVDate)} />
                      }
                      outerRadius={100}
                      dataKey="value"
                      minAngle={3}
                ...
                {siteTypes ? (
                  <PieChart>
                    ...
                    <Pie
                      ...
                      isAnimationActive={false}
                      label={
                        <CustomPieChartLabel total={getTotal(siteTypes)} />
                      }
                      outerRadius={100}
                      dataKey="value"
                      minAngle={3}
          ...
          <div>
            ...
            >
              <StyledTable
                ...
                columns={columnsDeviceFunctions}
              ...
              <StyledTable
                ...
                scroll={{ x: 1400 }}
                pagination={false}
                columns={columnsTotalDeviceFunctions}
                dataSource={toalFunctions}
                // rowKey="ne_ip_address"
                style={{ whiteSpace: "pre" }}
              />
            </StyledCard>

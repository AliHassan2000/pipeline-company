...
const AddDeviceModal = (props) => {
  ...
  /////////////////////////////
  let [ip, setIp] = useState(device ? getString(device.sfp_id) : "");
  ...
  return (
    <Modal
      style={{ marginTop: "-px", zIndex: "99999" }}
      width="50%"
      title=""
      closable={false}
      ...
      <form onSubmit={handleSubmit}>
        <Row gutter={30}>
          <Col span={24} style={{ textAlign: "center" }}>
            <p style={{ fontSize: "22px" }}>{device ? "Edit" : "Add"} SFP</p>
          </Col>
          <Col span={24}>
            <InputWrapper>
              SFP Id: &nbsp;<span style={{ color: "red" }}>*</span>
              &nbsp;&nbsp;
              {device ? (

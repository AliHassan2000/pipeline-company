...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        const res = await axios.get(baseUrl + "/getAllRebds");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "rebd");
    XLSX.writeFile(wb, "rebd.xlsx");

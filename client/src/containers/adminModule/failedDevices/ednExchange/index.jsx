...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllEdnExchangeFailedDevicesDates")
          .then((response) => {
        ...
        const res = await axios.get(
          baseUrl + "/getAllEdnExchangeFailedDevices"
        );
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(
      wb,
      binarySeedData,
      "ednexchangefaileddevices"
    );
    XLSX.writeFile(wb, "ednexchangefaileddevices.xlsx");
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getEdnExchangeFailedDevicesByDate", { date: value })
      .then((response) => {

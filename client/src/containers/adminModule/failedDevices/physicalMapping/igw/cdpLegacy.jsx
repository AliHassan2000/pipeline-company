...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllIgwCDPLegacyFailedDevicesDates")
          .then((response) => {
        ...
        const res = await axios.get(
          baseUrl + "/getAllIgwCDPLegacyFailedDevices"
        );
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(
      wb,
      binarySeedData,
      "igwcdplegacyfaileddevices"
    );
    XLSX.writeFile(wb, "igwcdplegacyfaileddevices.xlsx");
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getIgwCDPLegacyFailedDevicesByDate", { date: value })
      .then((response) => {

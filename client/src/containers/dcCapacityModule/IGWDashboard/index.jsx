...
const Index = (props) => {
  ...
  const onDatacenterChange = async (value) => {
    let dcmPortsGroup = await axios.post(baseUrl + "/igwDCMPortsGroup", {
      datacenter: value,
    });
    console.log(dcmPortsGroup.data);
    setTotal(dcmPortsGroup.data.total);
  ...
  return (
    ...
    >
      <StyledHeading>IGW DC Capacity</StyledHeading>
      <Row>
        <Col span={24} style={{}}>
          {dcmCounts ? (

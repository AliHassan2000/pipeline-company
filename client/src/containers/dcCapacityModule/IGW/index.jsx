...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllIgwDcCapacityDates")
          .then((response) => {
        ...
        const status = await axios.get(
          baseUrl + "/getIgwDcCapacityFetchStatus"
        );
        console.log("popo");
        console.log(status);
        ...
        const res = await axios.get(baseUrl + "/getAllIgwDcCapacity");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "igwdccapacity");
    XLSX.writeFile(wb, "igwdccapacity.xlsx");
  ...
  const fetch = async () => {
    ...
    setBackgroundColor("red");
    await axios
      .get(baseUrl + "/fetchIgwDcCapacity")
      .then((response) => {
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllIgwDcCapacityByDate", { date: value })
      .then((response) => {
        excelData = response.data;

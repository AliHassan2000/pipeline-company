...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllEdnExchangeDates")
          .then((response) => {
        ...
        const res = await axios.get(baseUrl + "/getAllEdnExchange");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "ednipam");
    XLSX.writeFile(wb, "ednexchange.xlsx");
  ...
  const columns = [
    ...
    {
      dataIndex: "ebgp_advertised_routes",
      key: "ebgp_advertised_routes",
      // ...getColumnSearchProps("device_a_mac"),
      ...getColumnSearchProps(
        "ebgp_advertised_routes",
        "EBGP Advertised Routes",
        setRowCount,
        setDataSource,
        excelData,
        columnFilters
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllEdnExchangeByDate", { date: value })
      .then((response) => {
        excelData = response.data;

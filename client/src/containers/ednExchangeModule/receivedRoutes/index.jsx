...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios.get(baseUrl + "/getAllVRFRoutesDates").then((response) => {
        ...
        const res = await axios.get(baseUrl + "/getAllVRFRoutes");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "ednexchangeroutes");
    XLSX.writeFile(wb, "ednexchangeroutes.xlsx");
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllVRFRoutesByDate", { date: value })
      .then((response) => {
        excelData = response.data;

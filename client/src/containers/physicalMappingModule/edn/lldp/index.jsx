...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllEdnLldpLegacyDates")
          .then((response) => {
        ...
        const status = await axios.get(
          baseUrl + "/getEdnLldpLegacyFetchStatus"
        );
        console.log("popo");
        console.log(status);
        ...
        const res = await axios.get(baseUrl + "/getAllEdnLldpLegacy");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.writeFile(wb, "ednLldplegacy.xlsx");
  ...
  const fetch = async () => {
    ...
    setBackgroundColor("red");
    await axios
      .get(baseUrl + "/fetchEdnLldpLegacy")
      .then((response) => {
  ...
  const columns = [
    ...
    {
      title: "EDN LLDP Id",
      dataIndex: "edn_lldp_legacy_id",
      key: "edn_lldp_legacy_id",
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllEdnLldpLegacyByDate", { date: value })
      .then((response) => {
        excelData = response.data;

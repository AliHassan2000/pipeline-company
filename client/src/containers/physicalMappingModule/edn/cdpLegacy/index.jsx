...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllEdnCdpLegacyDates")
          .then((response) => {
            setDates(response.data);
            console.log(response);
          });

        const status = await axios.get(baseUrl + "/getEdnCdpLegacyFetchStatus");
        console.log("popo");
        console.log(status);
        ...
        const res = await axios.get(baseUrl + "/getAllEdnCdpLegacy");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.writeFile(wb, "edncdplegacy.xlsx");
  ...
  const columns = [
    ...
    },
    {
      ...
      // sortOrder: sortedInfo.columnKey === "modification_date" && sortedInfo.order,
      ellipsis: true,
    },
    {
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllEdnCdpLegacyByDate", { date: value })
      .then((response) => {
        excelData = response.data;

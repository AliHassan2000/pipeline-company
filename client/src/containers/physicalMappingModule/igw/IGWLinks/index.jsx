...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        ...
        const res = await axios.get(baseUrl + "/getAllIgwLinks");
        excelData = res.data;
        // console.log("papi");
        // console.log(res);
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "igwlinks");
    XLSX.writeFile(wb, "igwlinks.xlsx");
  ...
  let seedTemp = [
    {
      ...
      community: "",
      ipv4_ingress_policy: "",
      ipv4_local_preference: "",
      ipv6_egress_policy: "",
      ipv6_ingress_policy: "",
      ipv6_local_preference: "",
      ipv4_advertised_routes_count: "",
      ipv4_received_routes_count: "",
      ipv6_advertised_routes_count: "",
      ipv6_received_routes_count: "",
    },
  ];
  ...
  const columns = [
    ...
    {
      dataIndex: "ipv4_egress_policy",
      key: "ipv4_egress_policy",
      // ...getColumnSearchProps("device_a_ip"),
      ...getColumnSearchProps(
        "ipv4_egress_policy",
        "IPV4 Egress policy",
    ...
    {
      dataIndex: "ipv4_ingress_policy",
      key: "ipv4_ingress_policy",
    ...
    {
      dataIndex: "ipv4_local_preference",
      key: "ipv4_local_preference",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv4_local_preference",
    ...
    {
      dataIndex: "ipv6_egress_policy",
      key: "ipv6_egress_policy",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv6_egress_policy",
        "IPV6 Egress Policy",
    ...
    {
      dataIndex: "ipv6_ingress_policy",
      key: "ipv6_ingress_policy",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv6_ingress_policy",
        "IPV6 Ingress Policy",
    ...
    {
      dataIndex: "ipv6_local_preference",
      key: "ipv6_local_preference",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv6_local_preference",
    ...
    {
      dataIndex: "ipv4_advertised_routes_count",
      key: "ipv4_advertised_routes_count",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv4_advertised_routes_count",
    ...
    {
      dataIndex: "ipv4_received_routes_count",
      key: "ipv4_received_routes_count",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv4_received_routes_count",
    ...
    {
      dataIndex: "ipv6_advertised_routes_count",
      key: "ipv6_advertised_routes_count",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv6_advertised_routes_count",
    ...
    {
      dataIndex: "ipv6_received_routes_count",
      key: "ipv6_received_routes_count",
      // ...getColumnSearchProps("device_b_interface"),
      ...getColumnSearchProps(
        "ipv6_received_routes_count",
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllIgwLinksbyDate", { date: value })
      .then((response) => {
        excelData = response.data;
        setDataSource(response.data);

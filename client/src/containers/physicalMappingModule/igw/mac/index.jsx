...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        await axios
          .get(baseUrl + "/getAllIgwMacLegacyDates")
          .then((response) => {
            setDates(response.data);
            console.log(response);
          });
        const status = await axios.get(baseUrl + "/getIgwMacLegacyFetchStatus");
        console.log("popo");
        console.log(status);
        ...
        const res = await axios.get(baseUrl + "/getAllIgwMacLegacy");
        excelData = res.data;
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.writeFile(wb, "ednmaclegacy.xlsx");
  ...
  const columns = [
    ...
    {
      title: "IGW MAC Id",
      dataIndex: "igw_mac_legacy_id",
      key: "igw_mac_legacy_id",
  ...
  const handleSelectChange = async (value) => {
    setLoading(true);
    await axios
      .post(baseUrl + "/getAllIgwMacLegacyByDate", { date: value })
      .then((response) => {
        excelData = response.data;

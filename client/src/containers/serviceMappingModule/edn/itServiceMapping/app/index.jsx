...
const Index = (props) => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        ...
        const res = await axios.get(baseUrl + "/appTable");
        excelData = res.data;
        // console.log("papi");
        // console.log(res);
  ...
  const jsonToExcel = (seedData) => {
    ...
    XLSX.utils.book_append_sheet(wb, binarySeedData, "app");
